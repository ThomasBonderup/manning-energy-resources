 ...
 */
package com.thomasbonderup.manning.devices.raw.milestone2;  
...
public class RawRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7117686626740883547L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RawRecord\",\"namespace\":\"com.thomasbonderup.manning.devices.raw.milestone2\",\"fields\":[{\"name\":\"uuid\",\"type\":\"string\"},{\"name\":\"arrival_time_ms\",\"type\":[\"long\",\"null\"]},{\"name\":\"body\",\"type\":[\"bytes\",\"null\"]},{\"name\":\"body_reference\",\"type\":[\"string\",\"null\"]}]}");
   ...
   */
  public static com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.Builder newBuilder() {
    return new com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.Builder();
  }
   ...
   * @return A new RawRecord RecordBuilder
   */
  public static com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.Builder newBuilder(com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.Builder other) {
    return new com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.Builder(other);
  }
   ...
   * @return A new RawRecord RecordBuilder
   */
  public static com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.Builder newBuilder(com.thomasbonderup.manning.devices.raw.milestone2.RawRecord other) {
    return new com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RawRecord>
    ...
    private Builder() {
      super(com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.thomasbonderup.manning.devices.raw.milestone2.RawRecord other) {
            super(com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.SCHEMA$);
      if (isValidValue(fields()[0], other.uuid)) {
        this.uuid = data().deepCopy(fields()[0].schema(), other.uuid);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.Builder setUuid(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.Builder clearUuid() {
      uuid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.Builder setArrivalTimeMs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.Builder clearArrivalTimeMs() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.Builder setBody(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.Builder clearBody() {
      body = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.Builder setBodyReference(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.thomasbonderup.manning.devices.raw.milestone2.RawRecord.Builder clearBodyReference() {
      body_reference = null;
