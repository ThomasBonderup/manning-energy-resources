# Device schema
```
curl --location --request POST 'http://localhost:8080/device/52a9351a-7030-434d-932c-dd0fe4d3b052' \
...
"processor1_temp":99,
"charging":-147,
"current_capacity":7133,
"inverter_state":10,
"moduleL_temp":193,
"moduleR_temp":16,
"processor3_temp":78,
"SoC_regulator":27.055288
}
```
...
```bash
$ sql="CREATE TABLE devices (uuid varchar, state bool)" && \
  docker exec -it manning-postgres psql -U postgres -c "${sql}"
```
